...
@section('title', 'Search - SMPN 1 Cibadak')
			...
			<div class="post_list">
				...
				<div class="post_entry_list">
					...
					<div class="post_thumb">
						<img src="{{ asset('upload/'.$n->thumbnail) }}" alt="Post1" />
					</div>
					<div class="post_description">
						<p>{!! excerpt($n->isiBerita) !!}</p>
					</div>
					<div class="post_action">
						...
						<div class="action_right">
							<a href="{{ url('blog/'.$n->id.'/'.ganti($n->title)) }}" class="read_more_btn">More</a>
						</div>
						<div class="clear"></div>
					</div>
				</div>
			...
			<div class="sidebar">
				...
				<div class="sidebar_box">
					...
					<div class="sidebar_content">
						<ul>
							@foreach($recent as $a)
							<li><a href="{{ url('blog/'.$a->id.'/'.ganti($a->title)) }}">{{ $a->title }}</a></li>
							@endforeach
						</ul>
					</div>
				</div>
