...
@section('title', 'List Saran - SMPN 1 Cibadak')
...
@section('breadcrumbs')
	  <h1>
        Saran
        <small>lihat list saran yang telah di publish oleh pengunjung</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">List saran</li>
      </ol>
@endsection
...
@section('content')
	  <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">List Saran</h3>
        </div>
        <div class="box-body">
