...
@section('content')
	  {!! Form::model($beritaEdit, ['url' => route('admin.berita.update', $beritaEdit->id),'method'=>'put', 'files'=>true]) !!}
	  <div class="row">
        <div class="col-md-9">
          <div class="box box-default">
            ...
            <div class="form-group">
              <input type="text" name="title" placeholder="Post Title" class="form-control" value="{{ $beritaEdit->title }}">
            </div>
            <div class="form-group">
              <textarea name="isiBerita" style="min-height: 300px;">{{ $beritaEdit->isiBerita }}</textarea>
            </div>
            </div><!-- /.box-body -->
          </div><!-- /.box -->
        </div>
        <div class="col-md-3">
          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="form-group">
                <input type="text" name="lable" class="form-control" value="{{ $beritaEdit->lable }}">
              </div>
            </div><!-- /.box-body -->
          </div><!-- /.box -->
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="form-group">
                <div class="input-group date" data-provide="datepicker">
                  <input type="text" class="form-control" name="postedAt" value="{{ $beritaEdit->postedAt }}">
