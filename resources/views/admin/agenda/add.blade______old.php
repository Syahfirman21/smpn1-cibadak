            ...
            <div class="col-md-9">
              <div class="box box-default">
                ...
                <div class="form-group">
                  <input type="text" name="titleAgenda" placeholder="Post Title" class="form-control">
                </div>
                <div class="form-group">
                  <textarea name="descAgenda" style="min-height: 300px;"></textarea>
                </div>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div>
                  ...
                  <div class="bootstrap-timepicker">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control timepicker" name="jamMulai">
                        <div class="input-group-addon">
                ...
                <div class="box-body">
                  ...
                  <div class="bootstrap-timepicker">
                    <div class="form-group">
                      <label>Waktu:</label>
                      <div class="input-group">
                        <input type="text" class="form-control timepicker" name="jamSelesai">
                        <div class="input-group-addon">
                          <i class="fa fa-clock-o"></i>
                        </div>
                      </div><!-- /.input group -->
